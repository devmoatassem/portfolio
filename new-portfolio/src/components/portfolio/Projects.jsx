...
function Projects() {
    const proj_list = [
        {
            title: 'CoinTrack',
            pic: p1, // always add image of 16-9 ratio
            ...
            <div className="flex flex-col md:gap-8 md:flex-row mx-auto max-w-lg md:max-w-[70rem] md:h-96 rounded-lg border shadow-lg border-gray-600 md:p-8 p-6 bg-gray-800 text-white">
                ...
                <div className='flex flex-col h-auto justify-center text-center w-full md:w-[25rem] px-4 py-8'>
                    ...
                    <div className='flex gap-4 justify-evenly mt-12'>
                        ...
                        <a href={proj.github} className='fill-white hover:fill-gray-950 text-white hover:text-gray-950 inline-flex items-center gap-2'>Github
                        ...
                        {
                            proj.live ? (
                                <a href={proj.live} className='fill-white hover:fill-gray-950 text-white hover:text-gray-950  inline-flex items-center gap-2'>Live
    ...
    return (
        <section className="relative">
            ...
            <div className="max-w-screen-xl container  mx-auto">
                <div className="flex w-full items-center justify-center py-20 px-4">
                    <ul>
                        {redered_proj_list}
                    </ul>
