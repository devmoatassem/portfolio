    ...
    <nav className="bg-transparent w-full header top-0 left-0 z-50 h-auto absolute">
      <div className="max-w-screen-xl flex flex-wrap items-center mx-auto p-4 justify-between">
        ...
        <div className="flex md:order-2">
          <Link className="container rounded-lg border shadow-lg border-gray-600 bg-gray-700  gap-3 inline-flex items-end fill-white hover:fill-blue-700 text-white hover:text-blue-700 font-medium px-3 py-2 md:px-7 md:py-2.5 text-center mr-1 md:mr-0 ">
