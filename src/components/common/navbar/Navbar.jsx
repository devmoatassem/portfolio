    ...
    <nav className="bg-transparent w-full header top-0 left-0 z-50 h-auto absolute">
      <motion.div
        ...
        <div
          ...
          <div className="container rounded-lg border shadow-lg border-gray-600 bg-gray-700  items-end fill-white text-white  font-medium px-3 py-2 md:px-7 md:py-2.5 text-center mr-1 md:mr-0" >
            <motion.div
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}>
              <Link to="mailto:moatassemsindhu@gmail.com" className="inline-flex hover:underline hover:underline-offset-4 gap-3">
